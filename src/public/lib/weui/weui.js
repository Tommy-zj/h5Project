  ...
  return /** ****/ (function(modules) {
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function dialog() {
        ...
        var $dialogWrap = (0, _util2.default)(
          _util2.default.render(_dialog2.default, options)
        )
        ...
        $dialogWrap
          .on('click', '.weui-dialog__btn', function(evt) {
            ...
            if (options.buttons[index].onClick) {
              if (options.buttons[index].onClick.call(this, evt) !== false) {
                hide()
              }
            } else {
              hide()
	...
	*/
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function alert() {
        ...
        if (
          (typeof yes === 'undefined' ? 'undefined' : _typeof(yes)) === 'object'
        ) {
          options = yes
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function confirm() {
        ...
        if (
          ...
          (typeof no === 'undefined' ? 'undefined' : _typeof(no)) === 'object'
        ) {
          options = no
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function toast() {
        ...
        var $toastWrap = (0, _util2.default)(
          _util2.default.render(_toast2.default, options)
        )
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function loading() {
        ...
        var $loadingWrap = (0, _util2.default)(
          _util2.default.render(_loading2.default, options)
        )
    ...
    /** */ function(module, exports) {
      module.exports =
        '<div class="weui-loading_toast <%= className %>" role=alert> <div class=weui-mask_transparent></div> <div class=weui-toast> <i class="weui-loading weui-icon_toast"></i> <p class=weui-toast__content><%=content%></p> </div> </div> '
      /** */
    },
    /* 13 */
    /** */ function(module, exports, __webpack_require__) {
      ...
      function actionSheet() {
        ...
        var $actionSheetWrap = (0, _util2.default)(
          _util2.default.render(_actionSheet2.default, options)
        )
        ...
        $actionSheet
          .addClass(
            options.isAndroid ? 'weui-animate-fade-in' : 'weui-animate-slide-up'
          )
          .on('animationend webkitAnimationEnd', function(evt) {
            evt.target.focus()
          })
        ...
        $actionSheetWrap
          ...
          .on('click', '.weui-actionsheet__cell', function(evt) {
            var index = (0, _util2.default)(this).index()
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function topTips(content) {
        ...
        var $topTips = (0, _util2.default)(
          _util2.default.render(_topTips2.default, options)
        )
        function _hide(callback) {
          _hide = _util2.default.noop // 防止二次调用导致报错
    ...
    /** */ function(module, exports) {
      module.exports =
        '<div class="weui-toptips weui-toptips_warn <%= className %>" style=display:block role=alert><%= content %></div> '
      /** */
    },
    /* 17 */
    /** */ function(module, exports, __webpack_require__) {
      ...
      function uploader(selector, options) {
        ...
        if (options.onBeforeQueued) {
          ...
          options.onBeforeQueued = function(file, files) {
            ...
            var $item = (0, _util2.default)(
              _util2.default.render(_item2.default, {
                id: file.id
              })
            )
        ...
        if (options.onError) {
          ...
          options.onError = function(file, err) {
            ...
            if (!onError.call(file, err)) {
              findFileCtn($uploader, file.id).html(
    ...
    /** */ function(module, exports) {
      module.exports =
        '<li class="weui-uploader__file weui-uploader__file_status" data-id="<%= id %>" role=img> <div class=weui-uploader__file-content> <i class=weui-loading style=width:30px;height:30px></i> </div> </li> '
      /** */
    },
    /* 22 */
    /** */ function(module, exports) {
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function picker() {
        ...
        var $picker = (0, _util2.default)(
          _util2.default.render(_picker2.default, defaults)
        )
        var $confirm = $picker.find('#weui-picker-confirm')
        var $mask = $picker.find('.weui-mask')
        var depth =
            options.depth || (isMulti ? items.length : util.depthOf(items[0])),
          groups = ''
        ...
        function scroll(items, level) {
          if (
            ...
            defaults.defaultValue[level] !== undefined
          ) {
          ...
          $picker
            ...
            .scroll({
              ...
              onChange: function onChange(item, index) {
                // 为当前的result赋值。
                if (item) {
                  var $currentGroup = $picker
                    .find('.weui-picker__group')
                    .eq(level)
                  $currentGroup
                    .find('.weui-picker__item')
      ...
      function datePicker(options) {
        ...
        var date = []
        var interval = _cron2.default.parse(
          defaults.cron,
          defaults.start,
          defaults.end
        )
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      var getDefaultTranslate = function getDefaultTranslate(
        offset,
        rowHeight,
        items
      ) {
      ...
      _util2.default.fn.scroll = function(options) {
        ...
        var items = defaults.items
          .map(function(item) {
            return (
              '<div role="option" title="\u6309\u4F4F\u4E0A\u4E0B\u53EF\u8C03" tabindex="0" class="weui-picker__item' +
              (item.disabled ? ' weui-picker__item_disabled' : '') +
              '">' +
              ((typeof item === 'undefined' ? 'undefined' : _typeof(item)) ==
              'object'
                ? item.label
        ...
        var stop = function stop(diff) {
          ...
          // 移动到最接近的那一行
          translate =
            Math.round(translate / defaults.rowHeight) * defaults.rowHeight
        ...
        function _move(pageY) {
          ...
          // 移动到最接近的那一行
          newTranslate =
            Math.round(newTranslate / defaults.rowHeight) * defaults.rowHeight
        ...
        function _end(pageY) {
          ...
          var relativeY =
            $this[0].getBoundingClientRect().top + defaults.bodyHeight / 2
          end = pageY
          ...
          if (endTime - startTime > 100) {
            ...
            if (Math.abs(end - start) > 10) {
              ...
              for (
                var i = endPos;
                i > 0 && startTime - points[i].time < 100;
                i--
              ) {
                startPos = i
              }
    ...
    /** */ function(module, exports) {
      module.exports =
        '<div class=weui-picker__group role=listbox tabindex=0> <div class=weui-picker__mask></div> <div class=weui-picker__indicator></div> <div class=weui-picker__content></div> </div> '
      /** */
    },
    /* 30 */
    /** */ function(module, exports, __webpack_require__) {
      ...
      function gallery(url) {
        ...
        var $gallery = (0, _util2.default)(
          _util2.default.render(
            _gallery2.default,
            _util2.default.extend(
              {
                url: url
    ...
    /** */ function(module, exports, __webpack_require__) {
      ...
      function slider(selector) {
        ...
        if (
          (options.defaultValue !== undefined && options.defaultValue < 0) ||
          options.defaultValue > 100
        ) {
        ...
        $eles.forEach(function(ele) {
          ...
          var sliderLength = parseInt(
            _util2.default.getStyle($sliderInner[0], 'width')
          ) // slider的长度
